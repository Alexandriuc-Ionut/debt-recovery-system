...
// Emails use .invalid TLD so no real emails are delivered during demo seed
const CLIENT_DATA = [
  { name: 'DEDEMAN SRL',                      cui: '2816464',  email: 'achizitii@dedeman.invalid',      phone: '+40 234 206 800', address: 'Str. Calea Romanului nr. 24, Bacau' },
  { name: 'EMAG INTERNET SRL',                cui: '2921185',  email: 'business@emag.invalid',           phone: '+40 374 107 007', address: 'Str. Avionului nr. 8B, Sector 1, Bucuresti' },
  { name: 'AUTOMOBILE DACIA SA',              cui: '1463252',  email: 'furnizori@dacia.invalid',         phone: '+40 248 501 100', address: 'Str. Uzinei nr. 1, Mioveni, Arges' },
  { name: 'OMV PETROM SA',                    cui: '1590082',  email: 'procurement@petrom.invalid',      phone: '+40 21 406 0000', address: 'Str. Coralilor nr. 22, Sector 1, Bucuresti' },
  { name: 'KAUFLAND ROMANIA SCS',             cui: '11279758', email: 'office@kaufland.invalid',         phone: '+40 21 207 0000', address: 'Str. Barbu Vacarescu nr. 120, Bucuresti' },
  { name: 'BANCA COMERCIALA ROMANA SA',       cui: '361757',   email: 'vendors@bcr.invalid',             phone: '+40 21 407 4200', address: 'Bd. Regina Elisabeta nr. 5, Sector 3, Bucuresti' },
  { name: 'ORANGE ROMANIA SA',                cui: '1639906',  email: 'b2b@orange.invalid',              phone: '+40 21 203 5000', address: 'Str. Lascar Catargiu nr. 47-53, Bucuresti' },
  { name: 'VODAFONE ROMANIA SA',              cui: '9010105',  email: 'business@vodafone.invalid',       phone: '+40 21 201 1200', address: 'Calea Dorobantilor nr. 239, Sector 1, Bucuresti' },
  { name: 'BRD GROUPE SOCIETE GENERALE SA',   cui: '361579',   email: 'achizitii@brd.invalid',           phone: '+40 21 301 6100', address: 'Bd. Ion Mihalache nr. 1-7, Sector 1, Bucuresti' },
  { name: 'ALTEX ROMANIA SRL',                cui: '1596639',  email: 'procurement@altex.invalid',       phone: '+40 21 201 2222', address: 'Str. Fabrica de Glucoza nr. 5, Bucuresti' },
  { name: 'CONSTRUCT PLUS SRL',               cui: '33451872', email: 'office@constructplus.invalid',    phone: '0756 123 456',    address: 'Str. Industriilor nr. 14, Cluj-Napoca' },
  { name: 'AGRO TRANS SRL',                   cui: '24567891', email: 'agrotrans@agrotrans.invalid',     phone: '0744 987 654',    address: 'Str. Principala nr. 45, Brasov' },
  { name: 'IT SOLUTIONS GRUP SRL',            cui: '38901234', email: 'contact@itsolutions.invalid',     phone: '0723 456 789',    address: 'Bd. Unirii nr. 23, Iasi' },
  { name: 'METAL EXPERT SA',                  cui: '12890456', email: 'office@metalexpert.invalid',      phone: '0751 234 567',    address: 'Str. Metalurgiei nr. 7, Timisoara' },
  { name: 'FARM NATURA SRL',                  cui: '29834567', email: 'info@farmnatura.invalid',         phone: '0765 678 901',    address: 'Str. Campului nr. 3, Craiova' },
  { name: 'LOGISTIC RAPID SRL',               cui: '41237890', email: 'logistic@rapid.invalid',          phone: '0733 890 123',    address: 'Str. Transportatorilor nr. 18, Constanta' },
  { name: 'ENERGY SOLAR SRL',                 cui: '35678901', email: 'contact@energysolar.invalid',     phone: '0712 345 678',    address: 'Str. Soarelui nr. 5, Cluj-Napoca' },
  { name: 'CLEAN SERVICES SRL',               cui: '28901234', email: 'office@cleanservices.invalid',    phone: '0742 901 234',    address: 'Str. Curatenie nr. 10, Bucuresti' },
  { name: 'PRIM CONSULTING SRL',              cui: '37654321', email: 'consulting@prim.invalid',         phone: '0761 543 210',    address: 'Bd. Eroilor nr. 30, Ploiesti' },
  { name: 'SMART TECH SRL',                   cui: '44123789', email: 'smart@tech.invalid',              phone: '0754 321 987',    address: 'Str. Inovatiei nr. 2, Sibiu' },
  { name: 'TEXTIL FASHION SRL',               cui: '19876543', email: 'fashion@textil.invalid',          phone: '0722 876 543',    address: 'Str. Fabricii nr. 20, Bacau' },
  { name: 'PRODUSE LEMN SRL',                 cui: '26543210', email: 'lemn@produse.invalid',            phone: '0743 210 987',    address: 'Str. Forestiera nr. 8, Suceava' },
  { name: 'MED PHARMA SRL',                   cui: '32109876', email: 'pharma@med.invalid',              phone: '0711 098 765',    address: 'Str. Sanatatii nr. 15, Galati' },
  { name: 'TURISM ACTIV SRL',                 cui: '21098765', email: 'turism@activ.invalid',            phone: '0766 765 432',    address: 'Str. Turistilor nr. 6, Sinaia' },
  { name: 'AUTO PIESE SRL',                   cui: '27890123', email: 'piese@auto.invalid',              phone: '0755 890 123',    address: 'Str. Mecanicilor nr. 4, Pitesti' },
  { name: 'GRAV CONSTRUCT SRL',               cui: '43210987', email: 'office@gravconstruct.invalid',    phone: '0732 098 765',    address: 'Str. Constructorilor nr. 12, Oradea' },
  { name: 'DATA SYSTEMS SRL',                 cui: '36789012', email: 'data@systems.invalid',            phone: '0753 789 012',    address: 'Str. Digitala nr. 9, Iasi' },
  { name: 'VERDE AGRO SRL',                   cui: '23456789', email: 'agro@verde.invalid',              phone: '0744 456 789',    address: 'Str. Campurilor nr. 22, Buzau' },
  { name: 'IMPEX GLOBAL SRL',                 cui: '39012345', email: 'global@impex.invalid',            phone: '0721 012 345',    address: 'Str. Comertului nr. 17, Tulcea' },
  { name: 'RETAIL STAR SRL',                  cui: '31234567', email: 'star@retail.invalid',             phone: '0763 234 567',    address: 'Str. Comerciala nr. 33, Arad' },
];
